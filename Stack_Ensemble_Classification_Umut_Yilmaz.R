...
X_train <- read.csv("training_data_r.csv", header = TRUE)
Y_train <- read.csv("training_label_r.csv", header = TRUE)
X_test <- read.csv("test_data_r.csv", header = TRUE)
...
write.table(test_predictions, file = "test_predictions.csv", row.names = FALSE, sep = ",")
